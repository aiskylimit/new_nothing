...
nvidia-smi
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 /tmp/llm_pretrain_burn.py > llm_pretrain_burn.log 2>&1 &
...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /tmp/llm_pretrain_burn.py > /dev/null 2>&1 &
