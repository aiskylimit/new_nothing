...
export DATA_DIR="${DATA_DIR:-$ASSET_ROOT/data/pickapic_v2_full}"
...
export RATIO_PICKAPIC_PROMPTS_SOURCE="${RATIO_PICKAPIC_PROMPTS_SOURCE:-$EVAL_SOURCE_DIR/pickapic_test.parquet}"
export RATIO_PARTIPROMPT_SOURCE="${RATIO_PARTIPROMPT_SOURCE:-$EVAL_SOURCE_DIR/PartiPrompts.tsv}"
export RATIO_HPDV2_SOURCE="${RATIO_HPDV2_SOURCE:-$EVAL_SOURCE_DIR/hpdv2_test.json}"
...
export RATIO_AESTHETIC_CLIP_CHECKPOINT="${RATIO_AESTHETIC_CLIP_CHECKPOINT:-$REWARD_ROOT/open_clip/ViT-L-14-openai.pt}"
...
export WHEELHOUSE_DIR="${WHEELHOUSE_DIR:-$ASSET_ROOT/wheelhouse}"
export VENV_DIR="${VENV_DIR:-$PROJECT_ROOT/.venv-offline-b200}"
