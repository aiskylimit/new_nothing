...
T_MAX_PROMPT_LENGTH="${T_MAX_PROMPT_LENGTH:-$((MAX_PROMPT_LENGTH + ${CONTEXT_MAX_NEW_TOKENS:-1024}))}"
# Reserve the longest possible student response, including short-prompt rows.
