...
python $INFER_SCRIPT \
    ...
    --tgt_prefix_mod \
    --encode_output_path "infer/FastVLM-0.5B_span_attn_sigreg_cls" \
...
python ./er_statistic.py \
    --pt_dir "infer/FastVLM-0.5B_span_attn_sigreg_cls"/${INFER_SUBSETS[0]}/query \
    --normalize_by_min_dim \
    --output_file "analyze/FastVLM-0.5B_span_attn_sigreg_cls.txt"
