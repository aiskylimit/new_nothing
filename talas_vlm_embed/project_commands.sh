...
CUDA_VISIBLE_DEVICES=0 bash script_full/train_distill_sigreg_cls.sh 1 1 0 1 1.0 0.5 &
CUDA_VISIBLE_DEVICES=1 bash script_full/train_distill_sigreg_cls.sh 1 1 0 1 1.0 0.2 &
CUDA_VISIBLE_DEVICES=1 bash script_full/train_distill_sigreg_cls.sh 1 1 1 1 2.0 0.1 &
CUDA_VISIBLE_DEVICES=2 bash script_full/train_distill_sigreg_cls.sh 1 1 1 1 1.0 0.5 &
CUDA_VISIBLE_DEVICES=2 bash script_full/train_distill_sigreg_cls.sh 1 1 0 1 2.0 0.1 &
# wait
