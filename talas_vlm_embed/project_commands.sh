...
# CUDA_VISIBLE_DEVICES=3 bash script_full/train_distill_sigreg_vqa.sh 1 1 1 1 1.0 0.5 &
# CUDA_VISIBLE_DEVICES=3 bash script_full/train_distill_sigreg_vqa.sh 1 1 1 1 1.0 0.05 &
...
CUDA_VISIBLE_DEVICES=3 bash script_full/train_distill_sigreg_llava_ov_cls.sh 1 1 1 1 1.0 0.1 &
