...
CUDA_VISIBLE_DEVICES=0 bash script_full/train_distill_sigreg_cls.sh 1 1 1 0 1.0 5.0 9 0.05 &
...
CUDA_VISIBLE_DEVICES=1 bash script_full/train_distill_sigreg_cls.sh 1 1 1 1 2.0 1.0 9 0.05 &
# # wait
...
# CUDA_VISIBLE_DEVICES=0 bash script_full/infer_erank_analyze_cls.sh 1 1 1 1 1.0 1.0 9 0.02
