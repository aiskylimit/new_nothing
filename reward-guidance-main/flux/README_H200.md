...
python sample.py \
  ...
  --method second_order --beta 1 --gradient-norm-scale 10 \
...
```text
k_eig=16 W_cols=16 correction_strength=... min_precision=...->... positive_scale=...
```
...
- `min_precision` sau ổn định phải dương và không nhỏ hơn precision floor.
